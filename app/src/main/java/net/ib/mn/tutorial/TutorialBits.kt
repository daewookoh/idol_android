 ...
 * 튜토리얼 비트 상수 정의
 *
 * 서버와 동기화되는 비트마스크 기반 튜토리얼 시스템
 * - 비트가 ON(1) = 튜토리얼 표시 필요
 * - 비트가 OFF(0) = 튜토리얼 완료됨
 *
 * old 프로젝트와 동일한 상수값 유지 (서버 호환성)
 */
object TutorialBits {
    ...
    // ============================================================
    const val MY_HEART_VIDEO_AD = 37        // 비디오 광고 버튼
    ...
    /**
     * 전체 튜토리얼 비트 리스트
     * MENU_QUIZ(17)는 화면에서 제거 예정이므로 제외
     */
    val all = listOf(
        ...
        MENU_SUPPORT, MENU_CERTIFICATE, MENU_DAILY_STAMP, MENU_NOTICE,
        ...
        MY_HEART_VIDEO_AD, MY_HEART_FREE_HEART, MY_HEART_HEART_SHOP, MY_HEART_EARN,
