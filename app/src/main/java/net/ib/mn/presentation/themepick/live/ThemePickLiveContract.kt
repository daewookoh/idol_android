...
/**
 * ThemePickLive (테마픽 순위 결과) 화면의 MVI Contract.
 *
 * old 프로젝트: ThemePickLiveActivity, ThemePickLiveAdapter
 *
 * 투표하고 나서 현재 순위를 보여주는 화면.
 */
class ThemePickLiveContract {

    /**
     * UI State for ThemePickLive screen.
     */
    data class State(
