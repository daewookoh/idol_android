...
class EmailSigninFragment : BaseFragment() {
    ...
    private fun setEventListener() {
        binding.inputEmail.setOnFocusChangeListener { _, _ ->
            binding.inputEmailLayout.setBackgroundResource(R.drawable.edit_underline_click)
            binding.inputPasswdLayout.setBackgroundResource(R.drawable.edit_underline)
        }

        binding.inputPasswdLayout.setOnFocusChangeListener { _, _ ->
            binding.inputEmailLayout.setBackgroundResource(R.drawable.edit_underline)
            binding.inputPasswdLayout.setBackgroundResource(R.drawable.edit_underline_click)
        }
        ...
        binding.btnSignin.setOnClickListener {
            val drawableInputError = ContextCompat.getDrawable(requireContext(), R.drawable.join_disapproval)
