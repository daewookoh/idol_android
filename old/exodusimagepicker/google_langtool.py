...
#docurl_idol = 'https://docs.google.com/spreadsheets/d/12J5tfsL1p5PphnKwYruy7uMLStPn-0AXTP9jDUBaplw/export?usp=sharing&format=csv'
docurl_idol = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQG3mVLQRnndinbvSX2BDNbtr1PChpb4b5rGyGrZPyJy24-TXbYrkHn8V-T4Mqw6UV41W0QF_fbS6v-/pub?gid=703460711&single=true&output=csv'
# android:ios table
...
msgids = []
(count, skips) = parse(docurl_idol+"&gid=1001399927")
print(u'앱 시트에서 %s개 추가' % count)
if len(skips) > 0:
    print(u'앱 시트에서 중복되어 건너뜀: ' + ', '.join(skips))
