...
import feature.common.exodusimagepicker.databinding.FragmentBannerImgFilePickerBinding
...
class BannerImgFilePickerFragment : ImagePickerBaseFragment<FragmentBannerImgFilePickerBinding>(R.layout.fragment_banner_img_file_picker) {
    ...
    private val pickerSharedViewModel: PickerViewModel by activityViewModels {
        object : ViewModelProvider.Factory {
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                return PickerViewModel(filePagingRepository) as T
            }
        }
    }
    ...
    override fun FragmentBannerImgFilePickerBinding.onCreateView() {
        initSet()
    ...
    private fun initSet() {
        ...
        binding.ivSelectedPhoto.apply {
            maxScale = 6.0f
            // 포토뷰 -> 짧은 비율 기준으로 꽉차게 만들
    ...
    private fun getDataFromViewModel() {
        ...
        pickerSharedViewModel.fileList.observe(viewLifecycleOwner) {
        ...
        pickerSharedViewModel.isFolderListShown.observe(viewLifecycleOwner) { isFolderListShown ->
            if (!isFolderListShown) {
                binding.ivSelectedPhoto.setImage(ImageSource.uri(pickerSharedViewModel.presentShownMediaPath ?: ""))
                binding.ivSelectedPhoto.orientation = SubsamplingScaleImageView.ORIENTATION_USE_EXIF
            }
        }
    ...
    private fun setListenerEvent() {
        ...
        filePagingAdapter.setItemClickListener(object : FilePagingAdapter.ItemClickListener {
            ...
            override fun onItemClickListener(
                ...
                // 싱글 피커이므로 파일 선택시 리스트 비워주고, 다시 선택한다.
                GlobalVariable.selectedFileIds.clear()
                GlobalVariable.selectedFileIds.add(fileModel.id)
                ...
                binding.ivSelectedPhoto.orientation = SubsamplingScaleImageView.ORIENTATION_USE_EXIF // 이미지 자동 회전 방지
            }
        })
    }
}