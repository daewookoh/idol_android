package net.ib.mn.billing.util.onestore
 ...
 */
object AppSecurity {
    private val TAG: String = AppSecurity::class.java.simpleName
    ...
    fun generatePublicKey(encodedPublicKey: String?): PublicKey {
        try {
            ...
            throw SecurityException("RSA not available", e)
    ...
    fun generatePayload(): String {
        ...
        //length : 20자
        for (i in 0..19) {
            randomString.append(payload[random.nextInt(payload.size)])
        }
