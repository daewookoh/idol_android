...
fun BasicHistoryTop3Item(
    ...
    Row(
        ...
        Box(
            ...
            val rankPainterResource = when (data.rank + 1) {
            ...
            rankPainterResource?.let {
                Icon(
                    modifier = Modifier
                        .align(Alignment.Center)
                        .offset(y = (-11).dp),
                    painter = painterResource(id = rankPainterResource),
                    contentDescription = "ranking_crown",
...
@Preview
@Composable
fun PreviewBasicHistoryTop3Item() {
