 ...
 */
@AndroidEntryPoint
class SobaAggregatedFragment : BaseFragment(), SobaAggregatedAdapter.OnClickListener {

    private lateinit var binding: AwardsRankingFragmentBinding
    private var mRankingAdapter: SobaAggregatedAdapter? = null
    ...
    private fun setAdapter() {
        ...
        mRankingAdapter = SobaAggregatedAdapter(
            requireActivity(),
            requireContext(),
