...
data class ChatRoomListModel(
    ...
    @ColumnInfo(name = "is_JoinedRoom") var isJoinedRoom: Boolean = false,//내가  참여한  채팅방인지 여부
    @ColumnInfo(name = "nickName") var nickName: String?= "",
    @ColumnInfo(name = "is_RoomFilter")var isRoomFilter: Boolean =false,
    @ColumnInfo(name = "account_id") var accountId: Int = 0,
 )
