...
@AndroidEntryPoint
class Hda2022Fragment : BaseFragment(), HeartDreamAwardAdapter.OnClickListener {
    ...
    private fun awardPeriod(startDate: String, endDate: String){
        ...
        mRankingAdapter?.setAwardPeriod(String.format(getString(R.string.gaon_voting_period),
