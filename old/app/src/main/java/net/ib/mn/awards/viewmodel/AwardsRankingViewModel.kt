...
import net.ib.mn.awards.viewmodel.AwardsMainViewModel.Companion
...
/**
 * 어워즈 실시간 순위 뷰모델 (누적 순위와 별개로 관리하기 위함)
 */
class AwardsRankingViewModel(
    ...
    fun setSaveState(requestChartCodeModel: AwardChartsModel?, currentStatus: String?) {
        ...
        savedStateHandle[AwardsMainViewModel.CHART_MODEL] = requestChartCodeModel
        savedStateHandle[AwardsMainViewModel.CURRENT_STATUS] = currentStatus
    }
