...
@AndroidEntryPoint
class AwardsBottomSheetActivity : BaseActivity(), BestChoice2023Adapter.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding =
            DataBindingUtil.setContentView(this, R.layout.awards_ranking_fragment)
...
//    }
    ...
    companion object {
        ...
        fun createIntent(
            ...
            val intent = Intent(context, AwardsBottomSheetActivity::class.java)
